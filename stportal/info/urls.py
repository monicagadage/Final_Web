...
urlpatterns = [
    ...
    # path('student/<slug:class_id>/search/', views.student_search, name='student_search'),
     ...
     path('message/<slug:teacher_id>/',
         views.messageTeacher, name='messageTeacher'),
     path('messageStudent/<slug:stud_id>/',
         views.messageStudent, name='messageStudent'),
     
      path('room/<slug:stud_name>/<slug:teacher_id>/<int:choice>/',
